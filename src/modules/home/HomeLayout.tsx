  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
      <nav className="sticky top-0 z-20 h-14 w-full bg-resume-800 flex py-2.5 px-4 xl:px-60 items-center shadow-level-8dp">
        <Link href="/">
          <Image src={'/icons/logo-white.png'} alt="logo" height="36" width="172" />
        </Link>
          ...
          >
            ...
            <div className="col-span-12 sm:col-span-8">
              <h3 className="text-xl md:text-2xl mb-2 text-resume-400">
                CÁCH ĐƠN GIẢN NHẤT ĐỂ TẠO MỘT
              </h3>
              <h1 className="text-5xl mb-12 text-resume-800">CV Chuyên Nghiệp</h1>

              <div className="flex mb-10">
                <div className="bg-resume-800 w-1 rounded-lg"></div>
                <p className="text-lg ml-3 text-resume-800">
                  &ldquo;Bí quyết để tiến lên phía trước là bắt đầu&rdquo;
                  <br />
                  —Mark Twain
                </p>
              </div>
              ...
              >
                Khuyến nghị sử dụng màn hình máy tính
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-12 items-center text-center">
            <div className="col-span-12 lg:col-span-4 mb-4 lg:mb-0 flex flex-col items-center gap-2">
              ...
              <p className="text-resume-800 text-xl mt-2">
                Bạn muốn tạo mẫu <strong>riêng của mình?</strong>
              </p>
            </div>
            ...
            <div className="col-span-12 lg:col-span-2 flex flex-col items-center gap-2">
              ...
              <p className="text-resume-800 text-xl mt-2">
                Bạn có viết code <strong>React</strong> không?
              </p>
            </div>
      ...
      <div
        ...
        style={{ fontFamily: "'Roboto Slab', serif" }}
      >
        <h2 className="text-resume-800 text-3xl mb-2 text-center lg:text-left">Về chúng tôi</h2>
        <p className="text-resume-400 mb-8 text-center lg:text-left">
          Một nhóm các nhà phát triển và thiết kế - những người yêu thích xây dựng các dự án mã
          nguồn mở và cùng nhau học hỏi!
        </p>
