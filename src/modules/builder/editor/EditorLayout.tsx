  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-purple-50 w-80 p-6 rounded shadow-lg relative animate-[fadeIn_.3s]">
        <h2 className="text-xl font-semibold mb-3">Đặt lại tất cả thay đổi</h2>
        <p className="text-gray-600 mb-4 text-center">
          Bạn có chắc chắn muốn đặt lại tất cả các thay đổi bạn đã thực hiện không?
        </p>
  ...
  return (
    <ErrorBoundary>
      <div className="bg-resume-50 h-full text-resume-800 p-6 overflow-auto relative no-scrollbar shadow-level-4dp">
        ...
        <div className="mt-8">
          <OutlinedButton onClick={confirmationModalHandler}>
            Đặt lại tất cả chỉnh sửa
          </OutlinedButton>
        </div>
      </div>
      {shouldOpenModal && (
